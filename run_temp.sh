#!/bin/bash
# Run script for Homework 2 EECS 583 Fall 2023, do not modify
...
PATH2LIB="/home/zwgold/F23_EECS583_HW2/build/hw2pass/HW2Pass.so"        # Specify your build directory in the project
